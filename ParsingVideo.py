...
class ParsingVideo():
    def getData(self):
        ...
        for filename in os.listdir(directory):
            if filename.startswith("4_")  and (filename.endswith(".MP4") or filename.endswith(".mp4")):
                            ...
                            if originalhex in data.hex():
                                ...
                                if data[0:4].hex() == 'fa555555' and rec[2]!=0:
                                    ...
                                    list.append(SortItems(str(msgID), str(sendername), str(recivedname), str(timestamp),
                                                          str(file), str(VedioPath),str(type)))
        ...
        directory = r"dump\Telegram Video"
        for filename in os.listdir(directory):
            if filename.startswith("4_") and (filename.endswith(".MP4") or filename.endswith(".mp4")):
                VedioPath = os.path.join(directory, filename)
                        ...
                        if ((mediaBlob[0:4].hex() != 'fa555555') and (rec[1] > 0)):
                            ...
                            if sentrec != None:
                                ...
                                if originalhex in data.hex() and sentrec[4]!=0:
                                    ...
                                    list.append(SortItems(str(msgID), str(sendername), str(recivedname), str(timestamp),
                                                          str(file), str(VedioPath),str(typeN)))
