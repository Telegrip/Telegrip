    ...
    def getData(self):
        ...
        for filename in os.listdir(directory):
            if filename.endswith(".ogg") or filename.endswith(".m4a"):
                AudioPath = os.path.join(directory, filename)
                file = filename
                filename = filename[2:]
                ...
                try:
                        ...
                        sql = "SELECT * from media_v2 where type = '2';"
                                ...
                                if originalhex in data.hex():
                                    ...
                                    if data[0:4].hex() == 'fa555555' and rec[2]!=0:
                                        ...
                                        list.append(SortItems(str(msgID), str(sendername), str(recivedname), str(timestamp),
                                                          str(file), str(AudioPath), str(type)))
        ...
        directory1 = 'dump/Telegram Documents'


        for filename in os.listdir(directory1):

            if filename.endswith(".ogg") or filename.endswith(".m4a"):
                AudioPath = os.path.join(directory1, filename)
                        ...
                        if ((mediaBlob[0:4].hex() != 'fa555555') and (rec[1] > 0)):
                            ...
                            if sentrec != None:
                                ...
                                if originalhex in data.hex() and sentrec[4]!=0:
                                    ...
                                    list.append(SortItems(str(msgID), str(sendername),
                                                          str(recivedname), str(timestamp),
                                                          str(file), str(AudioPath),str(typeN)))
        ...
        for filename in os.listdir(directory1):
            ...
            if filename.endswith(".ogg") or filename.endswith(".m4a"):
                        ...
                        if ((mediaBlob[0:4].hex() != 'fa555555') and (rec[1] > 0)):
                            ...
                            if sentrec != None:
                                ...
                                if originalhex in data.hex() and sentrec[4]!=0:
                                    ...
                                    senderID = (data[16:20].hex())
                                    senderID = str(int((struct.pack('<L', int(senderID, base=16))).hex(), 16))
                                    index = round(str(data.hex()).find("00000000") / 2)
                                    timestamp = sentrec[4]
                                    timestamp = time.strftime('%A %B %d, %Y %I:%M:%S %p', time.localtime(timestamp))
                ...
                continue
        directory2 = 'dump/Telegram Audio'
        for filename in os.listdir(directory2):
            if filename.endswith(".ogg") or filename.endswith(".m4a"):
                AudioPath = os.path.join(directory2, filename)
